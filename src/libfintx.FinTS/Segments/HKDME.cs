...
namespace libfintx.FinTS
{
    public static class HKDME
    {
        ...
        /// <summary>
        /// Softics fork: collective collect with a ready-made pain message.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        /// </para>
        /// <para>
        /// The segment version comes from the bank parameter data (HIDMES) instead of being
        /// guessed. Version 2 carries the total amount as an own data element; version 1 does
        /// not. Sending a version 2 header with version 1 data elements is the kind of error
        /// that the bank reports as a plain rejection.
        /// </para>
        /// </remarks>
            ...
            decimal totalAmount, string descriptor)
        {
            ...
            var version = PainDescriptor.SegmentVersion(client, "HIDMES", 1, 2);
